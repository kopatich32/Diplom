                ...
                <div class="track-area">
					<?php
						...
						while ($track_data = $query->fetch_assoc()):
							...
							?>
                            <div id="<?= $track_data['id'] ?>" class="current-track-main"
                                 data-track_id="<?= $track_data['id'] ?>">
                                ...
                                <div style="display:none;" class="listening-main play_now"><?= $track_data['listening'] ?></div>
                                <div style="display: none" class="is_play">
...
<audio style="display:none;" class="audioTag" id="" src="tracks/Deafheaven_-_The_Gnashing.mp3" controls>
</audio>
